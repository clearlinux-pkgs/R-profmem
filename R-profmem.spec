...
Version  : 0.5.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/profmem_0.5.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/profmem_0.5.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603317681
...
/usr/lib64/R/library/profmem/extdata/broken.Rprofile.out
